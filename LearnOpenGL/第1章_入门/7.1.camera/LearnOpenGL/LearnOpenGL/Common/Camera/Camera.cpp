...
Camera::Camera(glm::vec3 position, glm::vec3 up, float yaw, float pitch) : Front(glm::vec3(0.0f, 1.0f, 0.0f)), MovementSpeed(kSpeed), MouseSensitivity(kSensitivity), Zoom(kZoom)
{
    Position = position;
    WorldUp = up;
    Yaw = yaw;
...
Camera::Camera(GLfloat posX, GLfloat posY, GLfloat posZ, GLfloat worldUpX, GLfloat worldUpY, GLfloat worldUpZ, GLfloat yaw, GLfloat pitch) : Front(glm::vec3(0.0f, 1.0f, 0.0f)), MovementSpeed(kSpeed), MouseSensitivity(kSensitivity), Zoom(kZoom)
{
